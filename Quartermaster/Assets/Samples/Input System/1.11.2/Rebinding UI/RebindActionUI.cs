...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        /// <summary>
        /// TMPro.TextMeshProUGUI component that receives the name of the action. Optional.
        /// </summary>
        ...
        /// <summary>
        /// TMPro.TextMeshProUGUI component that receives the display string of the binding. Can be <c>null</c> in which
        ...
        private void ResetBinding(InputAction action, int bindingIndex)
        {
            ...
            foreach (InputAction otherAction in action.actionMap.actions){
                ...
                for (int i = 0; i < otherAction.bindings.Count; i+=1){
        ...
        private bool CheckDuplicateBindings(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            if (allCompositeParts){
                for (int i = 1; i < bindingIndex; i+=1){
                    // lowkey not sure if this is supposed to be newBinding.effectivePath or overridePath
